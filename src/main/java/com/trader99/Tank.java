...
public class Tank {
    ...
    Image getImage() {
        switch (direction) {
            case UP:
                return new ImageIcon("asserts/images/tankU.gif").getImage();
            case UPLEFT:
                return new ImageIcon("asserts/images/tankLU.gif").getImage();
            case UPRIGHT:
                return new ImageIcon("asserts/images/tankRU.gif").getImage();
            case DOWN:
                return new ImageIcon("asserts/images/tankD.gif").getImage();
            case DOWNLEFT:
                return new ImageIcon("asserts/images/tankLD.gif").getImage();
            case DOWNRIGHT:
                return new ImageIcon("asserts/images/tankRD.gif").getImage();
            case LEFT:
                return new ImageIcon("asserts/images/tankL.gif").getImage();
            case RIGHT:
                return new ImageIcon("asserts/images/tankR.gif").getImage();
