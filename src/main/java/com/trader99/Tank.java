...
public class Tank {
    ...
    Image getImage() {
        ...
        switch (direction) {
            case UP:
                return new ImageIcon("asserts/images/" + prefix + "tankU.gif").getImage();
            case UPLEFT:
                return new ImageIcon("asserts/images/" + prefix + "tankLU.gif").getImage();
            case UPRIGHT:
                return new ImageIcon("asserts/images/" + prefix + "tankRU.gif").getImage();
            case DOWN:
                return new ImageIcon("asserts/images/" + prefix + "tankD.gif").getImage();
            case DOWNLEFT:
                return new ImageIcon("asserts/images/" + prefix + "tankLD.gif").getImage();
            case DOWNRIGHT:
                return new ImageIcon("asserts/images/" + prefix + "tankRD.gif").getImage();
            case LEFT:
                return new ImageIcon("asserts/images/" + prefix + "tankL.gif").getImage();
            case RIGHT:
                return new ImageIcon("asserts/images/" + prefix + "tankR.gif").getImage();
